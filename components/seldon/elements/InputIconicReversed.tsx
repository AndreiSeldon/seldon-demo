...
interface InputIconicReversedTokens {}

type InputIconicReversedProps = HTMLAttributes<HTMLElement> &
  InputIconicReversedTokens;

export const InputIconicReversed = ({
  style,
  ...props
}: InputIconicReversedProps) => {
