...
export function CardProductInline({
  ...
  return (
    <Frame
      className={"sdn-cardProduct sdn-cardProduct-M7oFbrUv " + className}
      {...props}
    >
      <TextblockDetails
        {...{ ...seldon.textblockDetailsProps, ...textblockDetailsProps }}
        className={
          "sdn-textblockDetails-u4x6Wrln sdn-textblockDetails-RdpAL30g sdn-textblockDetails " +
      ...
      <ButtonBar
        ...
        className={
          "sdn-buttonBar-KBL4snpS sdn-buttonBar-VrtkEXPr sdn-buttonBar " +
...
const seldon: CardProductInlineProps = {
  textblockDetailsProps: {},
  textblockDetailsTaglineProps: {
    children: "Tagline",
    htmlElement: "p",
