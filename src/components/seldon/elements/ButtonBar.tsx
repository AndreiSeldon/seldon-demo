  ...
  return (
    <Frame className={"sdn-buttonBar " + className} {...props}>
      <Button
        ...
        className={
          "sdn-button-IZFsYPWQ sdn-button " + (buttonProps?.className ?? "")
        }
      ...
      <Button
        ...
        className={
          "sdn-button-IZFsYPWQ sdn-button " + (button1Props?.className ?? "")
        }
      ...
      <Button
        ...
        className={
          "sdn-button-IZFsYPWQ sdn-button " + (button2Props?.className ?? "")
        }
