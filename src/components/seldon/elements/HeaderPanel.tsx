...
export function HeaderPanel({
  ...
  return (
    <Frame className={"sdn-headerPanel " + className} {...props}>
      <Title
        {...{ ...seldon.titleProps, ...titleProps }}
        className={
          "sdn-icon-iO80LeMB sdn-title " + (titleProps?.className ?? "")
        }
      />
      <Button
        {...{ ...seldon.buttonProps, ...buttonProps }}
        className={
          "sdn-button-kLhmAET5 sdn-button " + (buttonProps?.className ?? "")
        }
