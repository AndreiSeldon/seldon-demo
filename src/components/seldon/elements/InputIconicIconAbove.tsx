...
interface InputIconicIconAboveTokens {}

type InputIconicIconAboveProps = HTMLAttributes<HTMLElement> &
  InputIconicIconAboveTokens;

export const InputIconicIconAbove = ({
  style,
  ...props
}: InputIconicIconAboveProps) => {
