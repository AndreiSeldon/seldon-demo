...
export interface ListingTextHoverProps extends HTMLAttributes<HTMLLIElement> {
...
export function ListingTextHover({
  style,
  buttonIconicActionProps,
...
const defaultProps: ListingTextHoverProps = {
  buttonIconicActionProps: {
    style: {
      cursor: "pointer",
...
const defaultStyles: CSSProperties = {
  backgroundColor: "hsl(0deg 0% 30% / 50%)",
  cursor: "pointer",
