...
export interface CardProductHybridProps extends HTMLAttributes<HTMLElement> {
  className?: string
...
export function CardProductHybrid({
  className = "",
  avatar,
  image,
  textblockAvatar,
...
const sdn: CardProductHybridProps = {
  avatar: {},
  image: {
