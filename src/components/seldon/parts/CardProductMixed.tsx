          ...
          <Button
            ...
            icon={{
              ...
              className:
                "sdn-icon-1ihZT8Ll" +
                (icon?.className &&
                !icon.className.includes("sdn-icon-1ihZT8Ll")
                  ? " " + icon.className
                  : ""),
            }}
            label={{
              ...
              className:
                "sdn-label-1R07j0Td" +
                (label?.className &&
                !label.className.includes("sdn-label-1R07j0Td")
                  ? " " + label.className
                  : ""),
            }}
          />
        ...
        {tagline2 && (
          <Tagline
            ...
            className={
              "sdn-tagline-57ug71iC" +
              (tagline2?.className &&
              !tagline2.className.includes("sdn-tagline-57ug71iC")
                ? " " + tagline2.className
                : "")
            }
          />
      ...
      <ButtonBar
        ...
        button={{
          ...
          className:
            "sdn-button-JnRIw2cY" +
            (button2?.className &&
            !button2.className.includes("sdn-button-JnRIw2cY")
              ? " " + button2.className
              : ""),
        }}
        icon={{
        ...
        button3={{
          ...
          className:
            "sdn-button-3D4pvOBS" +
            (button4?.className &&
            !button4.className.includes("sdn-button-3D4pvOBS")
              ? " " + button4.className
              : ""),
        }}
        icon3={{
          ...
          className:
            "sdn-icon-1ihZT8Ll" +
            (icon4?.className && !icon4.className.includes("sdn-icon-1ihZT8Ll")
              ? " " + icon4.className
              : ""),
        }}
        label3={{
