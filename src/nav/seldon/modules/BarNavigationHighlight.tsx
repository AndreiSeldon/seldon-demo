...
export interface BarNavigationHighlightProps
 ...
 * ```
 */
export function BarNavigationHighlight({
  className = "",
  button = sdn.button,
  icon,
  label,
    ...
    >
      ...
      <Button
        ...
        icon={{
          ...
          ...icon5,
          className:
            "sdn-icon-AO_S-C" + (icon5?.className ? " " + icon5.className : ""),
        }}
        label={{
          ...sdn.label5,
          ...label5,
...
const sdn: BarNavigationHighlightProps = {
  button: {
    className: "sdn-button-3veJ8F",
  },
  icon: {
    icon: "material-home",
