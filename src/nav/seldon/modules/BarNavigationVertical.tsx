...
export interface BarNavigationVerticalProps
 ...
 * ```
 */
export function BarNavigationVertical({
  className = "",
  button = sdn.button,
  icon,
  label,
  ...
  label5,
  ...props
}: BarNavigationVerticalProps) {
  return (
    <Frame
      className={"sdn-barNavigation sdn-barNavigation-ZQcbKb " + className}
      {...props}
    >
      <Button
        {...{ ...sdn.button, ...button }}
      ...
      <Button
        ...
        icon={{
          ...
          ...icon5,
          className:
            "sdn-icon-1-ovdO" + (icon5?.className ? " " + icon5.className : ""),
        }}
        label={{
          ...sdn.label5,
          ...label5,
...
const sdn: BarNavigationVerticalProps = {
  button: {
    className: "sdn-button-oIGPVu",
  },
  icon: {
    icon: "material-home",
  ...
  label: {
    children: "Home",
    htmlElement: "span",
    className: "sdn-label-DoISPi",
  },
  button2: {
    className: "sdn-button-Uyw1Z9",
  },
  icon2: {
