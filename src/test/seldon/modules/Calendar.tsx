  ...
  return (
    <HTMLTable className={frameClassName} {...props}>
      ...
      <CalendarMonth
        ...
        tableData={tableData21Props}
        tableData={tableData22Props}
        tableData={tableData23Props}
        tableData={tableData24Props}
        calendarWeek4={calendarWeek4Props}
        tableData={tableData25Props}
        tableData={tableData26Props}
        tableData={tableData27Props}
        tableData={tableData28Props}
        tableData={tableData29Props}
        tableData={tableData30Props}
        tableData={tableData31Props}
        tableData={tableData32Props}
        calendarWeek5={calendarWeek5Props}
        tableData={tableData33Props}
        tableData={tableData34Props}
        tableData={tableData35Props}
        tableData={tableData36Props}
        tableData={tableData37Props}
        tableData={tableData38Props}
        tableData={tableData39Props}
        tableData={tableData40Props}
      />
    </HTMLTable>
  )
}
...
const sdn: CalendarProps = {
  calendarHeader: {
    className: "sdn-calendarHeader-AbtFAjlA",
  },
  calendarWeekdays: {
  ...
  calendarMonth: {
    className: "sdn-calendarMonth-4bFne7dq",
  },
  calendarWeek: {
    className: "sdn-calendarWeek-29OfcHeE",
  },
  tableData: {
    children: "01",
