...
const sdn: CalendarProps = {
  calendarHeader: {
    className: "sdn-calendarHeader-7EQuZ3Y8",
  },
  calendarWeekdays: {
    className: "sdn-calendarWeekdays-lAP2YmUY",
  },
  tableHeader: {
    children: "Jan",
    className: "sdn-tableHeader-j5jgBjTo",
  },
  tableHeader2: {
    children: "Mon",
    className: "sdn-tableHeader-0IiBlD4v",
  },
  tableHeader3: {
    children: "Tue",
    className: "sdn-tableHeader-0IiBlD4v",
  ...
  calendarMonth: {
    className: "sdn-calendarMonth-Rg4dcitf",
  },
  calendarWeek: {
    className: "sdn-calendarWeek-2SuleL14",
  },
  tableData: {
    children: "01",
    className: "sdn-tableData-6oEvYTeU",
  },
  tableData2: {
    className: "sdn-tableData-0Phh2iwv",
  },
  tableData3: {
    className: "sdn-tableData-0Phh2iwv",
  },
