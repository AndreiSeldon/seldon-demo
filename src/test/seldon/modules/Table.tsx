...
const sdn: TableProps = {
  tableHead: {
    className: "sdn-tableHead-EFjGFa0g",
  },
  tableRowHeader: {
    className: "sdn-tableRowHeader-H07JNyct",
  },
  tableHeader: {
    children: "Column",
    className: "sdn-tableHeader-1PLqxJSt",
  },
  tableHeader2: {
    children: "Column",
    className: "sdn-tableHeader-1PLqxJSt",
  ...
  tableBody: {
    className: "sdn-tableBody-MDK8tj9G",
  },
  tableRowData: {
  ...
  tableFoot: {
    className: "sdn-tableFoot-5QdpJNKF",
  },
  tableRowFooter: {
    className: "sdn-tableRowFooter-YQj6BBGY",
  },
  tableData16: {
    children: "Cell",
    className: "sdn-tableData-2eoPSiJA",
